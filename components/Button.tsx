...
export default function Button<T extends ElementType = "button">({ variant, as, children, hasArrow, ...props }: Props<T> & VariantProps<typeof buttonStyles> & Omit<ComponentPropsWithoutRef<T>, keyof Props<T>>) {
